...
<template>
  <div class="w-full h-screen relative">
    ...
    >
      ...
      >
        <svg
          ...
          aria-hidden="true"
          class="w-full h-full iconify iconify--noto"
        >
          <path
    ...
    <main class="w-full h-[calc(100vh-60px)] p-10 flex justify-center items-center">
      <div class="w-full max-w-360 h-full border">
        <slot />
      </div>
    </main>
  </div>
